 ...
 * @author Duskmourne
 */
public class OPDUXController implements Initializable,UIController {
    ...
    @FXML
    private TableView<Consultation> t1table;
    ...
    void addConsultation(ActionEvent event) {
        try{
            ...
            createBtn.setOnAction(crtEvt->{
                if(patientNameF.validate() && physicianF.validate()){
    ...
    void addPatient(ActionEvent event) {
        try{
            PatientRegistrationFormController.showDialog(mainStack, maskerPane, OPDUXController.this,t1addPatientBtn);
        }catch(Exception er){
             Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, er);
        }
    }
    ...
    public void loadCustomizations() {
        try{
            ...
            TableColumn timeCol = FXTable.addColumn(t1table, "Timestamp", Consultation::consultationtimeProperty, false, 150, 150, 150);
            FXTable.addColumn(t1table, "Patient Name", Consultation::patientnameProperty, false);
            FXTable.addColumn(t1table, "Physician", Consultation::physicianProperty, false);
            ...
            TableColumn actCol = FXTable.addColumn(t1table, " ", Consultation::patientnameProperty, false, 112, 112, 112);
                            ...
                            try {
                                ...
                                if (row_data != null) {
                                    ...
                                    JFXButton viewBtn = FXButtonsBuilderFactory.createButton("", 32, 32, "cell-btn", FontAwesomeIcon.EDIT, "14px", evt -> {
                                        ConsultationFormController.showDialog(row_data.getModelClone(), mainStack, maskerPane, OPDUXController.this);
                                    });
                                        ...
                                        FXTask task = new FXTask() {
                                            ...
                                            protected void load() {
                                                try {
                                                    ...
                                                    HospitalCharge charge = (HospitalCharge)SQLTable.get(HospitalCharge.class, HospitalCharge.RECORDTABLEID+"="+String.valueOf(row_data.getId())+" AND "+HospitalCharge.RECORDTABLE+"='"+Consultation.TABLE_NAME+"'");
                                                    if(charge!= null){
    ...
    private void loadOPDRecordFilters() {
        try {
            ...
            exportLb.setOnMouseClicked(evt -> {
                List<Consultation> records = t1table.getItems();
                if(records.size() > 0){
