 ...
 * @author Duskmourne
 */
public class FXTextEntry extends HBox{

    private final StringProperty label = new SimpleStringProperty("");
    
    private final Label labelComponent = new Label();    
    private final JFXTextField textfieldComponent = new JFXTextField();
     ...
     */
    public JFXTextField getTextfieldComponent() {
